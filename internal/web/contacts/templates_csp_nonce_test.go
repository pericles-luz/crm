...
// TestContactLayout_StampCSPNonce pins SIN-63275: the full-page contact
...
func TestContactLayout_StampCSPNonce(t *testing.T) {
	t.Parallel()
	style := branding.DefaultThemeStyle
	const nonce = "test-csp-nonce-contacts"
