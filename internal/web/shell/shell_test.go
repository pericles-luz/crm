...
func TestRender_BrandFallsBackToPithoWhenTenantNameEmpty(t *testing.T) {
	t.Parallel()
	body := renderShell(t, pageData{shell.Data{}})

	mustContain(t, body, `<span class="app-shell__brand-text">Pitho</span>`)
