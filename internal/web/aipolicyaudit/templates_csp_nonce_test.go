...
// TestPageLayout_StampCSPNonce pins SIN-63275: the full-page
// aipolicyaudit layout emits the <style id="tenant-theme"> with
...
func TestPageLayout_StampCSPNonce(t *testing.T) {
	...
	const nonce = "test-csp-nonce-aipolicyaudit"
